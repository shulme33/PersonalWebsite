  ...
  return (
    <div className="mp mp-fit mp-color-5" id="id-skills-section">
      <div className="imp imp-flex high-imp mp-txt-color-2 skills-container">
        ...
        />
        <SingleSkill skillName="HTML 5" skillLevel={3.5} />
        <SingleSkill skillName="CSS 3" skillLevel={3.5} />
        <SingleSkill skillName="JavaScript" skillLevel={3.5} />
        <SingleSkill skillName="React" skillLevel={3} />
        <SingleSkill skillName="Node.js" skillLevel={2.5} />
        ...
        <SingleSkill skillName="C Programming" skillLevel={3} />
        <SingleSkill skillName="SQL" skillLevel={3} />
        <div className="skills-divider"></div>
        <SingleSkill skillName="Git/GitHub" skillLevel={3.5} />
        ...
        <SingleSkill skillName="XAMPP" skillLevel={2.5} />
        <SingleSkill skillName="Figma" skillLevel={2.5} />
